"""
Note: Write a solution with O(n) time complexity and 
O(1) additional space complexity, since this is what you would 
...
numbers, return the number for which the second 
occurrence has a smaller index than the second 
